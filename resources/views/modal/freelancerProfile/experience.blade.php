<div id="experience" class="uk-flex-top" uk-modal>
    <div class="uk-modal-dialog uk-modal-body uk-margin-auto-vertical">
        ...
        <form method="post" action="?saf">
            ...
            <input name="start" required placeholder="Start Date" class="uk-input uk-search-input">
            <input name="end" required placeholder="End Date" class="uk-input uk-search-input">
